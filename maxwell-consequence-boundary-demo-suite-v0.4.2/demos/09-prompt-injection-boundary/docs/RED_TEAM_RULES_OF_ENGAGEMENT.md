# Red-Team Rules of Engagement — Demo 09
...
An attacker wins this public demo if a hostile input causes `bounded_effect_record.json` to be created without the evidence, authority, scope, policy, and required review/security/due-process conditions stated in `THREAT_MODEL.md` and `DEMO_SPEC.yml`.
...
- Public artifact boundaries: `bounded_effect_record.json` versus `NO_BOUNDARY_EFFECT_CREATED.txt`.
