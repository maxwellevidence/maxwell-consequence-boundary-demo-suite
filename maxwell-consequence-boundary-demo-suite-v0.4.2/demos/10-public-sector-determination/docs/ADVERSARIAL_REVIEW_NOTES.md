# Adversarial Review Notes — Demo 10
...
Adversarial cases should not create `determination_effect_record.json`. They should route to review, quarantine, suppression, pause, or block depending on the demo.
