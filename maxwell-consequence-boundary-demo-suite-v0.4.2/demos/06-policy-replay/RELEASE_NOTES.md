...
Initial public-preview release of Demo 06: Maxwell Policy Replay Demo.

Included:

- Original evaluation under policy v1.
- Replay evaluation under policy v2.
- Drift classification.
- Non-retroactive-effect proof case.
- Manifest verification for original records.
- Sample outputs for GitHub review.
