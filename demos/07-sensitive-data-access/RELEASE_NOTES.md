...
Initial public-preview package for Demo 07: Sensitive Data Access.

Includes:

- Six synthetic governed-retrieval cases.
- Data-access policy with role, purpose, dataset, data-class, minimization, and prompt-injection checks.
- Decision receipts, effect records, review tickets, suppression notices, manifests, and verification reports.
- Tests for core invariants and tamper detection.
- Public-package hygiene tools and sample outputs.
