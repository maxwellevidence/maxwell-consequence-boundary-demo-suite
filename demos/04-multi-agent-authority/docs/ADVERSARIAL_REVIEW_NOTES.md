# Adversarial Review Notes — Demo 04
...
Adversarial cases should not create `delegated_effect_record.json`. They should route to review, quarantine, suppression, pause, or block depending on the demo.
