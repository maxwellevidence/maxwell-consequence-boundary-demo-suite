# Adversarial Review Notes — Demo 08
...
Adversarial cases should not create `authorized_effect_record.json`. They should route to review, quarantine, suppression, pause, or block depending on the demo.
