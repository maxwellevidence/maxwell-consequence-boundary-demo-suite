# Adversarial Review Notes — Demo 03
...
Adversarial cases should not create `payment_effect_record.json`. They should route to review, quarantine, suppression, pause, or block depending on the demo.
