# Adversarial Review Notes — Demo 09
...
Adversarial cases should not create `bounded_effect_record.json`. They should route to review, quarantine, suppression, pause, or block depending on the demo.
